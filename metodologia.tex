...
$L_1$ verossimilhança do modelo completo, Este teste segue uma distribuição qui-quadrado $(\chi^2$
) com graus de liberdade iguais à diferença no número de parâmetros entre os dois modelos..
